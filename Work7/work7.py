...
is_fixed = ti.field(dtype=ti.i32, shape=N * N)

# 隐式欧拉专用的预测缓存场
x_next = ti.Vector.field(3, dtype=ti.f32, shape=N * N)
v_next = ti.Vector.field(3, dtype=ti.f32, shape=N * N)
f_next = ti.Vector.field(3, dtype=ti.f32, shape=N * N)
